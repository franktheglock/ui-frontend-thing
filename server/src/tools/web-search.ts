...
export class WebSearchTool extends BaseTool {
  id = 'web_search'
  name = 'web_search'
  description = 'Search the web for current information. When you use information from search results in your response, you MUST cite the source inline using [source:n] where n is the result number shown in the output. Use this tool for current facts, product comparisons, prices, benchmarks, rankings, specifications, If the user says something confusing, or if you are unsure about what the user is asking, use this tool. Do not answer from memory when the question could depend on up-to-date information.'
  parameters = {
    type: 'object',
    properties: {
      query: {
